...
*Statement of collaboration:* I did not collaborate with anyone on this assignment.
...
```{r TamirFig2SEM, echo=TRUE}
## Bonus: calculate SEM and add error bars
performance_diff_summary_d = performance_diff_d |>
  ## remove NA's before grouping/averaging 
  na.omit() |> ## (omit beforehand to account for mean, sd, and sqrt functions)
  group_by(ConfrontationalGame, MusicCondition) |>
